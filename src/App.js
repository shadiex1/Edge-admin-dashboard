...
submitFilter=(item)=>{
  ...
  render(){
   ...
   {/* <Route exact path={process.env.PUBLIC_URL +`/EditProduct/:id/:type`} component={() => <Form sizeType={this.state.sizeType} submitProduct={item=>this.submitProduct(item)} type="Product" colors={this.state.colors} sizes={this.state.sizes} washings={this.state.washings} categories={this.state.categories} filters={this.state.filters} products={this.state.products}/>}/>  */}
   <Route exact path={process.env.PUBLIC_URL +`/Add/:type`} component={() => <Form sizeType={this.state.sizeType}  submitProduct={item=>this.submitProduct(item)} type="Product" colors={this.state.colors} sizes={this.state.sizes}  colors={this.state.colors} sizes={this.state.sizes} washings={this.state.washings} categories={this.state.categories} filters={this.state.filters} products={this.state.products}/>}/> 
   <Route exact path={process.env.PUBLIC_URL +`/Edit/:type/:id`} component={() => <Form  sizeType={this.state.sizeType} submitFilter={item=>this.submitFilter(item)}type="Filter" filters={this.state.filters} colors={this.state.colors} sizes={this.state.sizes} categories={this.state.categories} washings={this.state.washings}/>}/>  
